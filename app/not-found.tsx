...
export default function NotFoundPage() {
  return (
    <main className="mx-auto flex min-h-screen max-w-3xl items-center px-6 py-16">
      <div className="card card-soft w-full rounded-[2rem] p-10">
        ...
        <Link
          href="/modules"
          className="accent-button mt-8 inline-flex rounded-full border border-[var(--border-strong)] bg-[var(--accent)] px-5 py-3 text-sm font-medium"
        >
          Back to modules
        </Link>
      </div>
